...
public class updataGrade extends JDialog implements ActionListener{
	...
	//title 窗口名字
	//model 模式窗口还是非模式窗口
	public updataGrade(Frame owner,String title,boolean modal,SCModel scm,int rowNums){
		...
		jtf4.setText((String)scm.getValueAt(rowNums,9));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==jb1){
			...
			String sql="update SC set 成绩=? where 学号=? and 课程号=?";
